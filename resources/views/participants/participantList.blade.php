            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:flex ml-10 space-x-8">
                        <a href="/participants" class="border-b-2 border-teal-400 text-white px-1 py-4 text-sm font-medium">
                            Participants
                        </a>
                        <a href="/courses" class="border-b-2 border-transparent text-gray-400 hover:text-gray-200 hover:border-gray-500 px-1 py-4 text-sm font-medium transition">
                            Courses
                        </a>
                    </div>
                </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-slate-800">
                    <tr>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-gray-300 uppercase tracking-wider">ID</th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-gray-300 uppercase tracking-wider">Student Profile</th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-gray-300 uppercase tracking-wider">Contact Info</th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-gray-300 uppercase tracking-wider">Status</th>
                        <th scope="col" class="px-6 py-3 text-right text-xs font-bold text-gray-300 uppercase tracking-wider">Manage</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-slate-50 transition duration-150 ease-in-out">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 rounded-lg bg-slate-100 flex items-center justify-center text-slate-600 font-bold border border-slate-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($participant->courses->count() > 0)
                                <span class="px-2.5 py-0.5 rounded-md text-xs font-medium bg-teal-100 text-teal-800 border border-teal-200">
                                    Active ({{ $participant->courses->count() }})
                                </span>
                            @else
                                <span class="px-2.5 py-0.5 rounded-md text-xs font-medium bg-gray-100 text-gray-600 border border-gray-200">
                                    Unregistered
                                </span>
                            @endif
                        </td>
