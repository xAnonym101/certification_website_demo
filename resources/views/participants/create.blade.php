...
<body class="bg-gray-100 font-sans text-slate-800">
    ...
    <div class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Add New Participant</h1>
                <p class="mt-1 text-sm text-slate-500">Register a new student into the system.</p>
            </div>
            <a href="/participants" class="text-slate-600 hover:text-slate-900 text-sm font-medium">
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
            ...
            <form action="{{ route('participants.store') }}" method="POST" class="p-6 space-y-6">
                @csrf <div>
                ...
                <div class="flex justify-end pt-4 border-t border-gray-100">
                    <button type="button" onclick="window.location.href='/participants'"
